...
export function FriendStatistics(): React.ReactElement {
    ...
    return (
        <div className="qd-friend-statistics">
            {friendStats.map(friend => (
                <div className="qd-friend-statistics_friend">
                    ...
                    <div className="qd-friend-statistics_stats">
                        <div className="qd-friend-statistics_won">{friend.n_games_won}</div>
                        <div className="qd-friend-statistics_tied">{friend.n_games_tied}</div>
                        <div className="qd-friend-statistics_lost">{friend.n_games_lost}</div>
                    </div>
                </div>
            ))}
        </div>
