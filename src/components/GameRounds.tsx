...
const QuestionItem = ({
    ...
    return (
        <div
            className="qd-game-round_question-block"
...
function GameRounds({
    gameRound,
    onQuestionClick,
}: IGameRoundsStateProps): React.ReactElement<IGameRoundsStateProps> {
            ...
            <div className="qd-game-round_questions">
                {roundAnswerIndices.map(i => (
                    <QuestionItem
                        key={i}
                        onClick={() => {
                            if (isAnswerClickable(round.yourAnswers, i)) {
                                onQuestionClick(r, i);
                            }
                        }}
            ...
            <div className="qd-game-round_questions">
                {roundAnswerIndices.map(i => (
                    <QuestionItem
                        key={i}
                        onClick={() => {
                            if (isAnswerClickable(round.opponentAnswers, i)) {
                                onQuestionClick(r, i);
                            }
                        }}
    ...
    return <div className="qd-game-rounds">{rounds}</div>;
}
