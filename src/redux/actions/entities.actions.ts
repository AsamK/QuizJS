...
export const giveUpGameAction = new ActionType<
    'GIVE_UP_GAME_REQUEST',
    'GIVE_UP_GAME_RESPONSE',
    'GIVE_UP_GAME_ERROR',
    IApiGameResponse,
    IApiPopup,
    { id: number }
...
export const uploadRoundAction = new ActionType<
    'UPLOAD_ROUND_REQUEST',
    'UPLOAD_ROUND_RESPONSE',
    'UPLOAD_ROUND_ERROR',
    IApiGameResponse,
    IApiPopup,
    { id: number }
...
export const uploadQuizRoundAction = new ActionType<
    'UPLOAD_QUIZ_ROUND_REQUEST',
    'UPLOAD_QUIZ_ROUND_RESPONSE',
    'UPLOAD_QUIZ_ROUND_ERROR',
    IApiQuizResponse,
    IApiPopup,
    { id: string }
...
export const loadGameStatsAction = new ActionType<
    'LOAD_GAME_STATS_REQUEST',
    'LOAD_GAME_STATS_RESPONSE',
    'LOAD_GAME_STATS_ERROR',
    IApiGameStats,
    IApiPopup
